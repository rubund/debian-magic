...
#ifndef lint
static char rcsid[] __attribute__ ((unused)) = "$Header: /usr/cvsroot/magic-7.5/dbwind/DBWcommands.c,v 1.1.1.1 2006/04/10 22:03:14 tim Exp $";
#endif  /* not lint */
...
extern void CmdSelect(), CmdSideways();
