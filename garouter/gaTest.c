...
#ifndef lint
static char rcsid[] __attribute__ ((unused)) = "$Header: /usr/cvsroot/magic-7.5/garouter/gaTest.c,v 1.1.1.1 2006/04/10 22:03:13 tim Exp $";
#endif  /* not lint */
...
GAGenChans(chanType, area, f)
    ...
    FILE *f;
{
    extern void DBPaintPlane(), DBPaintPlaneVert();
