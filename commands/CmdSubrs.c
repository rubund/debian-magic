...
#ifndef lint
static char rcsid[] __attribute__ ((unused)) = "$Header: /usr/cvsroot/magic-7.5/commands/CmdSubrs.c,v 1.8 2008/01/05 19:48:29 tim Exp $";
#endif  /* not lint */
    ...
    int scale;
{
	...
	else if (!strncmp(endptr, "micron", 5))
	    mscale = 1000;
