...
#ifndef lint
static char rcsid[] __attribute__ ((unused)) = "$Header: /usr/cvsroot/magic-7.5/extflat/EFflat.c,v 1.2 2006/05/12 06:21:47 tim Exp $";
#endif  /* not lint */
...
void efAddNodes(HierContext *, bool);
