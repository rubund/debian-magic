 ...
 *
 * rcsid $Header: /usr/cvsroot/magic-7.5/database/databaseInt.h,v 1.3 2008/01/04 20:34:50 tim Exp $
 */
...
#else
    PaintResultType	pue_oldtype;	/* Material erased */
    PaintResultType	pue_newtype;	/* Material painted */
#endif
