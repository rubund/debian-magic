...
#ifndef lint
static char rcsid[] __attribute__ ((unused)) = "$Header: /usr/cvsroot/magic-7.5/cif/CIFrdtech.c,v 1.4 2010/09/15 15:45:09 tim Exp $";
#endif  /* not lint */
 ...
 *
 * Return value:
 *   Return the multiplier value on success, or 0 on failure.
 *
 * ----------------------------------------------------------------------------
 */
