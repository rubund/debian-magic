...
#ifndef lint
static char rcsid[] __attribute__ ((unused)) = "$Header: /usr/cvsroot/magic-7.5/cif/CIFhier.c,v 1.1.1.1 2006/04/10 22:03:14 tim Exp $";
#endif  /* not lint */
				 ...
				 */
{
    ...
    /* Ignore tiles in vendor GDS */

    if (cxp->tc_scx->scx_use->cu_def->cd_flags & CDVENDORGDS) return 0;
